/* 
   This file is 99.4 % plotly code, and is available at
   https://github.com/plotly/dash-core-components/blob/master/src/components/Graph.react.js

   There is a package at https://www.npmjs.com/package/dash-core-components,
   but that is unfortunately only the minified versions.

   Everything below this comment and until the last comment can be replaced
   by updates in the Graph.react.js link mentioned above usually without any
   other changes.
*/
...
/************************************************************************
** End of Plotly maintained code. The lines below are Webviz specific: 
*************************************************************************/

PlotlyGraph.defaultProps.config.modeBarButtonsToRemove = ['sendDataToCloud', 'toImage']
PlotlyGraph.defaultProps.config.displaylogo = false
PlotlyGraph.defaultProps.config.responsive = true
