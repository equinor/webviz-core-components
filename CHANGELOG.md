...
### Added
- [#126](https://github.com/equinor/webviz-core-components/pull/126) - Added feedback button to `WebvizPluginPlaceholder`. Added `href` and `target` properties to `WebvizToolbarButton`.
